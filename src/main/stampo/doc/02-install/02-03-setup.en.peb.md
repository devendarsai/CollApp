...
After successfully launching the application, go to http://your-collapp-install/setup .
...
collapp does **not** store the user credentials by design: an external provider must be chosen. There are 3 possible choice:
...
If you want to manage your accounts inside collapp.
